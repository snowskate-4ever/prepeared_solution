        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <AuthenticatedLayout/>
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Авторы</h2>
                    <div class="p-6 text-gray-900">
                        <Link href="authors/create"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-2xl my-3">Добавить автора</button></Link>
                        <table class="table-auto w-full">
                            ...
                            <tr v-for="author in authors" :key="author.id">
                                ...
                                <td class="border px-4 py-2">
                                    ...
                                    <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-2xl ml-2" @click="deletePost(author.id)">Удл</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
